var contributors1 = httpGetAsync('https://api.github.com/users/sqli-nantes/repos?per_page=100', function(response) {
	...
	json.forEach(function(entry, index){
		if(entry.name == 'play2-war-plugin')
			index_project = index;
	});
	...
	var contributors2 = httpGetAsync('https://api.github.com/repos/sqli-nantes/play2-war-plugin/commits', function(response) {
	...
	var contributors3 = httpGetAsync('https://api.github.com/repos/sqli-nantes/play2-war-plugin/stats/contributors', function(response) {
