var contributors1 = httpGetAsync('https://api.github.com/users/sqli-nantes/repos?per_page=100', function(response) {
	...
	var contributors2 = httpGetAsync('https://api.github.com/repos/sqli-nantes/dzslides/commits', function(response) {
	...
	var contributors3 = httpGetAsync('https://api.github.com/repos/sqli-nantes/dzslides/stats/contributors', function(response) {
